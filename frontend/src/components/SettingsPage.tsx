...
const SettingsPage: React.FC<SettingsPageProps> = ({ prompts, onSetPrompts, onSetDefaultPrompt }) => {
    ...
    >
        <div className="max-w-3xl mx-auto">
            ...
            <motion.div variants={contentVariants} className="mb-12">
                ...
                <button className="w-full bg-[#222222] text-white font-medium tracking-widest uppercase py-3 px-4 hover:bg-[#B8860B] transition-all duration-300 ease-in-out transform hover:scale-105">
                    保存配置
                </button>
            </motion.div>
